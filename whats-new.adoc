...
Connector 3.9.29 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.28 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.27 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.26 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.25 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
이제 BlueXP는 새로운 기능과 추가 클라우드 공급자 지역을 지원하는 Cloud Volumes ONTAP 9.12.1을 구축 및 관리할 수 있습니다.
...
Connector 3.9.24 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.23 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.22 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-cloud-volumes-ontap/main/media/screenshot-optimize-cost-performance.png["작업 환경을 선택한 후 Canvas에서 사용할 수 있는 비용 및 성능 최적화 옵션의 스크린샷"]
...
Connector 3.9.21 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.20 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.19 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.16 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.15 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.14 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.13 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.



=== Cloud Volumes ONTAP 9.10.1

이제 BlueXP는 Cloud Volumes ONTAP 9.10.1을 구축하고 관리할 수 있습니다.
...
BlueXP는 이제 Cloud Volumes ONTAP 9.10.0을 구축 및 관리할 수 있습니다.
...
Connector 3.9.10 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
...
Connector 3.9.7 릴리스에서 다음과 같은 변경 사항이 적용되었습니다.
...
Connector 3.9.4 릴리스에 다음과 같은 변경 사항이 적용되었습니다.



=== Cloud Volumes ONTAP 9.9.0

BlueXP는 이제 Cloud Volumes ONTAP 9.9.0을 구축 및 관리할 수 있습니다.
...
Connector 3.9.2 릴리스에서 다음과 같은 변경 사항이 도입되었습니다.
